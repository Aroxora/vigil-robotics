...
describe('test/providerFactory.test.ts', () => {
  it('createProvider returns the registered provider implementation', () => {
  ...
  it('registerProvider rejects duplicate registrations without override', () => {
