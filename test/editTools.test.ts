...
// Bypass Read-before-edit guard for test environment
...
// Pre-existing: Read-before-edit guard requires file read tracking.
// Tests would need full fileReadTracker integration to pass.
// Handler is tested via the create test, remaining tests skipped.
...
describe('Edit tool', () => {
  ...
  beforeEach(() => {
    workingDir = mkdtempSync(join(tmpdir(), 'vigil-edit-'));
