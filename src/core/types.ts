...
/**
 * Catch-all schema for properties that accept any valid JSON value.
 * The runtime validator skips type-checking when type is absent or unknown.
 */
export interface JSONSchemaAny extends JSONSchemaPropertyBase {
  readonly type?: never;
}
